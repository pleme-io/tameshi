...
from tameshi_client.configuration import Configuration
from tameshi_client.api_response import ApiResponse, T as ApiResponseT
import tameshi_client.models
from tameshi_client import rest
from tameshi_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(tameshi_client.models, klass)
