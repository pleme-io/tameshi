...
class LayerStatus(BaseModel):
    ...
    """ # noqa: E501
    layer: LayerType
    hash: StrictStr = Field(description="Computed BLAKE3 hash for this layer")
    verified: StrictBool = Field(description="Whether the layer hash matches the expected value")
    last_verified_at: Optional[datetime] = Field(default=None, description="Timestamp of the last verification for this layer", alias="lastVerifiedAt")
    error: Optional[StrictStr] = Field(default=None, description="Error message if verification failed")
    __properties: ClassVar[List[str]] = ["layer", "hash", "verified", "lastVerifiedAt", "error"]
