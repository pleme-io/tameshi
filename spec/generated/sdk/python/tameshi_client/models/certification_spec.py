...
class CertificationSpec(BaseModel):
    ...
    """ # noqa: E501
    environment: StrictStr = Field(description="Target environment name")
    gates: List[StrictStr] = Field(description="Names of SignatureGate resources to include")
    audit_retention_days: Optional[StrictInt] = Field(default=None, description="Number of days to retain audit trail entries", alias="auditRetentionDays")
    __properties: ClassVar[List[str]] = ["environment", "gates", "auditRetentionDays"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if audit_retention_days (nullable) is None
        # and model_fields_set contains the field
        if self.audit_retention_days is None and "audit_retention_days" in self.model_fields_set:
            _dict['auditRetentionDays'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gates": obj.get("gates"),
            "auditRetentionDays": obj.get("auditRetentionDays")
        })
        return _obj
