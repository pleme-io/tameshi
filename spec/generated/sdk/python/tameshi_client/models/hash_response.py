...
class HashResponse(BaseModel):
    ...
    """ # noqa: E501
    compliance_hash: StrictStr = Field(description="BLAKE3 hash of the most recent compliance assessment", alias="complianceHash")
    environment: StrictStr = Field(description="Environment of the assessment")
    baseline: ComplianceBaseline
    computed_at: datetime = Field(description="When the hash was computed", alias="computedAt")
    __properties: ClassVar[List[str]] = ["complianceHash", "environment", "baseline", "computedAt"]
