...
class SignatureMetadata(BaseModel):
    ...
    """ # noqa: E501
    computed_at: datetime = Field(description="Timestamp when the signature was computed", alias="computedAt")
    collector_version: StrictStr = Field(description="Version of the collector that produced this signature", alias="collectorVersion")
    source: StrictStr = Field(description="Identifier for the source that produced the inputs")
    environment: Optional[StrictStr] = Field(default=None, description="Environment context for the computation")
    __properties: ClassVar[List[str]] = ["computedAt", "collectorVersion", "source", "environment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "collectorVersion": obj.get("collectorVersion"),
