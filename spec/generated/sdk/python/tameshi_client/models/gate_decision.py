...
class GateDecision(BaseModel):
    ...
    """ # noqa: E501
    allowed: StrictBool = Field(description="Whether the admission request was allowed")
    reason: StrictStr = Field(description="Human-readable reason for the decision")
    signature: StrictStr = Field(description="Current gate signature at time of decision")
    expected: StrictStr = Field(description="Expected gate signature at time of decision")
    decided_at: datetime = Field(description="Timestamp of the admission decision", alias="decidedAt")
    gate: StrictStr = Field(description="Name of the gate that made the decision")
    __properties: ClassVar[List[str]] = ["allowed", "reason", "signature", "expected", "decidedAt", "gate"]
