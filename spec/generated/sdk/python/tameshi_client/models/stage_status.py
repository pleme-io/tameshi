...
class StageStatus(BaseModel):
    ...
    """ # noqa: E501
    stage: StrictStr = Field(description="Stage name (e.g. source, build, image, chart, deployment)")
    passed: StrictBool = Field(description="Whether the stage passed")
    hash: StrictStr = Field(description="BLAKE3 hash of the stage attestation data")
    violations: List[StrictStr] = Field(description="Policy violations found in this stage")
    __properties: ClassVar[List[str]] = ["stage", "passed", "hash", "violations"]
