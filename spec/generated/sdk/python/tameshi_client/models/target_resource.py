...
class TargetResource(BaseModel):
    ...
    """ # noqa: E501
    group: StrictStr = Field(description="API group (e.g. apps, batch, empty string for core)")
    kind: StrictStr = Field(description="Resource kind (e.g. Deployment, Job)")
    operations: List[StrictStr] = Field(description="Admission operations to intercept (CREATE, UPDATE, DELETE)")
    __properties: ClassVar[List[str]] = ["group", "kind", "operations"]
