...
class Certification(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": CertificationSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": CertificationStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
