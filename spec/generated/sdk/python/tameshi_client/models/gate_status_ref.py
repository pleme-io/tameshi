...
class GateStatusRef(BaseModel):
    """
    Reference to a gate's status within a certification
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the referenced SignatureGate")
    verified: StrictBool = Field(description="Whether the gate is currently verified")
    phase: GatePhase
    last_checked_at: Optional[datetime] = Field(default=None, description="Timestamp of the last status check", alias="lastCheckedAt")
    __properties: ClassVar[List[str]] = ["name", "verified", "phase", "lastCheckedAt"]
