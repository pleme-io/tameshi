...
class ComplianceDimension(BaseModel):
    ...
    """ # noqa: E501
    dimension_type: DimensionType = Field(alias="dimensionType")
    hash: StrictStr = Field(description="BLAKE3 hash of the dimension assessment data")
    passed: StrictBool = Field(description="Whether this dimension passed")
    summary: StrictStr = Field(description="Human-readable summary of the assessment")
    assessed_at: datetime = Field(description="When this dimension was assessed", alias="assessedAt")
    required: StrictBool = Field(description="Whether this dimension is required for certification")
    __properties: ClassVar[List[str]] = ["dimensionType", "hash", "passed", "summary", "assessedAt", "required"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dimensionType": obj.get("dimensionType"),
            "hash": obj.get("hash"),
