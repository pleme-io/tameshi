...
class AdmissionDecisionCounts(BaseModel):
    """
    Running counts of admission decisions made by this gate
    """ # noqa: E501
    allowed: Optional[StrictInt] = Field(default=None, description="Number of requests allowed through the gate")
    denied: Optional[StrictInt] = Field(default=None, description="Number of requests denied by the gate")
    __properties: ClassVar[List[str]] = ["allowed", "denied"]
