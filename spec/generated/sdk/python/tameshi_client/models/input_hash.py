...
class InputHash(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Logical name of the input artifact")
    hash: StrictStr = Field(description="BLAKE3 hash of the input content")
    size: Optional[StrictInt] = Field(default=None, description="Size of the input in bytes")
    __properties: ClassVar[List[str]] = ["name", "hash", "size"]
