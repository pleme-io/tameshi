...
class ApiResponseResultSummaryList(BaseModel):
    """
    API response wrapping a list of compliance result summaries
    """ # noqa: E501
    data: List[ResultSummary] = Field(description="List of compliance result summaries")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ResultSummary.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
