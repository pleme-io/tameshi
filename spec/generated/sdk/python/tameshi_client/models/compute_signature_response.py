...
class ComputeSignatureResponse(BaseModel):
    """
    Result of a signature computation
    """ # noqa: E501
    signature: StrictStr = Field(description="Computed BLAKE3 composite signature")
    layers: List[StrictStr] = Field(description="Layer types that contributed to the signature")
    environment: StrictStr = Field(description="Environment the signature was computed for")
    __properties: ClassVar[List[str]] = ["signature", "layers", "environment"]
