...
class CertificationPipelineApi:
    ...
    def certify_product(
        self,
        certify_request: CertifyRequest,
        ...
        :param certify_request: (required)
        :type certify_request: CertifyRequest
        ...
        _param = self._certify_product_serialize(
            certify_request=certify_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApiResponseCertifyResponse",
            '400': "ErrorResponse",
        }
    ...
    @validate_call
    def certify_product_with_http_info(
        self,
        certify_request: CertifyRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiResponseCertifyResponse]:
        """Certify a product
    ...
    @validate_call
    def certify_product_without_preload_content(
        self,
        certify_request: CertifyRequest,
        _request_timeout: Union[
            None,
    ...
    def _certify_product_serialize(
        self,
        certify_request,
        _request_auth,
        _content_type,
        ...
        if certify_request is not None:
            _body_params = certify_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/compliance/certify',
