...
class CertificationsApi:
    ...
    def get_certification(
        self,
        name: Annotated[StrictStr, Field(description="Name of the Certification resource")],
        ...
        :param name: Name of the Certification resource (required)
        :type name: str
        ...
        _param = self._get_certification_serialize(
            name=name,
    ...
    @validate_call
    def get_certification_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Name of the Certification resource")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_certification_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Name of the Certification resource")],
        _request_timeout: Union[
            None,
    ...
    def _get_certification_serialize(
        self,
        name,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/certifications/{name}',
    ...
    def list_certifications_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[CertificationSummary]]:
        """List all certifications
    ...
    def _list_certifications_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/certifications',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
