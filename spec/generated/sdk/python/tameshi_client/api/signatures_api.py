...
class SignaturesApi:
    ...
    def compute_signature(
        self,
        compute_signature_request: ComputeSignatureRequest,
        ...
        :param compute_signature_request: (required)
        :type compute_signature_request: ComputeSignatureRequest
        ...
        _param = self._compute_signature_serialize(
            compute_signature_request=compute_signature_request,
    ...
    @validate_call
    def compute_signature_with_http_info(
        self,
        compute_signature_request: ComputeSignatureRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ComputeSignatureResponse]:
        """Compute a signature
    ...
    @validate_call
    def compute_signature_without_preload_content(
        self,
        compute_signature_request: ComputeSignatureRequest,
        _request_timeout: Union[
            None,
    ...
    def _compute_signature_serialize(
        self,
        compute_signature_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if compute_signature_request is not None:
            _body_params = compute_signature_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/signatures/compute',
