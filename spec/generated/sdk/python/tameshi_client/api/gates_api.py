...
class GatesApi:
    ...
    def get_gate(
        self,
        name: Annotated[StrictStr, Field(description="Name of the SignatureGate resource")],
        ...
        :param name: Name of the SignatureGate resource (required)
        :type name: str
    ...
    def _get_gate_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/gates/{name}',
    ...
    def verify_gate(
        self,
        name: Annotated[StrictStr, Field(description="Name of the SignatureGate resource to verify")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param name: Name of the SignatureGate resource to verify (required)
        :type name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._verify_gate_serialize(
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def verify_gate_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Name of the SignatureGate resource to verify")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def verify_gate_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Name of the SignatureGate resource to verify")],
        _request_timeout: Union[
            None,
    ...
    def _verify_gate_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/gates/{name}/verify',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
