...
class AuditApi:
    ...
    def get_audit_trail(
        self,
        environment: Annotated[StrictStr, Field(description="Environment name (e.g. plo, zek)")],
        ...
        :param environment: Environment name (e.g. plo, zek) (required)
        ...
        _param = self._get_audit_trail_serialize(
    ...
    @validate_call
    def get_audit_trail_with_http_info(
        self,
        environment: Annotated[StrictStr, Field(description="Environment name (e.g. plo, zek)")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_audit_trail_without_preload_content(
        self,
        environment: Annotated[StrictStr, Field(description="Environment name (e.g. plo, zek)")],
        _request_timeout: Union[
            None,
    ...
    def _get_audit_trail_serialize(
        self,
        environment,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/audit/{environment}',
