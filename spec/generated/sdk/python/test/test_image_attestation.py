...
class TestImageAttestation(unittest.TestCase):
    """ImageAttestation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageAttestation:
        """Test ImageAttestation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageAttestation`
        """
        model = ImageAttestation()
        if include_optional:
