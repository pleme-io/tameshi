...
class TestSignatureGateSpec(unittest.TestCase):
    """SignatureGateSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignatureGateSpec:
        """Test SignatureGateSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignatureGateSpec`
        """
        model = SignatureGateSpec()
        if include_optional:
            return SignatureGateSpec(
                layers = [
                    'nix'
                    ],
                expected_signature = '',
    ...
    def testSignatureGateSpec(self):
        """Test SignatureGateSpec"""
