...
class TestGateSummary(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GateSummary:
        """Test GateSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GateSummary`
        """
        model = GateSummary()
        if include_optional:
            return GateSummary(
