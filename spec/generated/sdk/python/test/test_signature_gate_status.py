...
class TestSignatureGateStatus(unittest.TestCase):
    """SignatureGateStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignatureGateStatus:
        """Test SignatureGateStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignatureGateStatus`
        """
        model = SignatureGateStatus()
        if include_optional:
            return SignatureGateStatus(
                phase = 'Pending',
                current_signature = '',
    ...
    def testSignatureGateStatus(self):
        """Test SignatureGateStatus"""
