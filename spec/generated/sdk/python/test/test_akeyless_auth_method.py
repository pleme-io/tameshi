...
class TestAkeylessAuthMethod(unittest.TestCase):
    """AkeylessAuthMethod unit test stubs"""
    ...
    def testAkeylessAuthMethod(self):
        """Test AkeylessAuthMethod"""
        # inst = AkeylessAuthMethod()
