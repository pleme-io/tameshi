...
class TestApiResponseRunResponse(unittest.TestCase):
    """ApiResponseRunResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseRunResponse:
        """Test ApiResponseRunResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseRunResponse`
        """
        model = ApiResponseRunResponse()
        if include_optional:
            return ApiResponseRunResponse(
                data = tameshi_client.models.run_response.RunResponse(
                    status = '', 
                    message = '', )
            )
        else:
    ...
    def testApiResponseRunResponse(self):
        """Test ApiResponseRunResponse"""
