...
class TestCertifyResponse(unittest.TestCase):
    """CertifyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CertifyResponse:
        """Test CertifyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CertifyResponse`
        """
        model = CertifyResponse()
        if include_optional:
