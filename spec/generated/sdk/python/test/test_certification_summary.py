...
class TestCertificationSummary(unittest.TestCase):
    """CertificationSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CertificationSummary:
        """Test CertificationSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CertificationSummary`
        """
        model = CertificationSummary()
        if include_optional:
    ...
    def testCertificationSummary(self):
        """Test CertificationSummary"""
