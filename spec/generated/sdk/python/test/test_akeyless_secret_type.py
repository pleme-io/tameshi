...
class TestAkeylessSecretType(unittest.TestCase):
    """AkeylessSecretType unit test stubs"""
    ...
    def testAkeylessSecretType(self):
        """Test AkeylessSecretType"""
        # inst = AkeylessSecretType()
