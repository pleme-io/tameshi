...
class TestComputeSignatureResponse(unittest.TestCase):
    """ComputeSignatureResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComputeSignatureResponse:
        """Test ComputeSignatureResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComputeSignatureResponse`
        """
        model = ComputeSignatureResponse()
        if include_optional:
    ...
    def testComputeSignatureResponse(self):
        """Test ComputeSignatureResponse"""
