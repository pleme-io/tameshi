...
class TestBuildAttestation(unittest.TestCase):
    """BuildAttestation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BuildAttestation:
        """Test BuildAttestation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuildAttestation`
        """
        model = BuildAttestation()
        if include_optional:
