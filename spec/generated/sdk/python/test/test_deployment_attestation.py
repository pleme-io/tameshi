...
class TestDeploymentAttestation(unittest.TestCase):
    """DeploymentAttestation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeploymentAttestation:
        """Test DeploymentAttestation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeploymentAttestation`
        """
    ...
    def testDeploymentAttestation(self):
        """Test DeploymentAttestation"""
