...
class TestGateVerifyResult(unittest.TestCase):
    """GateVerifyResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GateVerifyResult:
        """Test GateVerifyResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GateVerifyResult`
        """
        model = GateVerifyResult()
        if include_optional:
