...
class TestLayerVerification(unittest.TestCase):
    """LayerVerification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LayerVerification:
        """Test LayerVerification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LayerVerification`
        """
        model = LayerVerification()
        if include_optional:
    ...
    def testLayerVerification(self):
        """Test LayerVerification"""
