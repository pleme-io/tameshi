...
class TestMasterSignature(unittest.TestCase):
    """MasterSignature unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MasterSignature:
        """Test MasterSignature
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MasterSignature`
        """
        model = MasterSignature()
        if include_optional:
            return MasterSignature(
                ...
                secure = '',
                layers = [
                    tameshi_client.models.layer_signature.LayerSignature(
                        layer = 'nix', 
                        hash = '', 
