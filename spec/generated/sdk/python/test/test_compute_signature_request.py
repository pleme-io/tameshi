...
class TestComputeSignatureRequest(unittest.TestCase):
    """ComputeSignatureRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComputeSignatureRequest:
        """Test ComputeSignatureRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComputeSignatureRequest`
        """
        model = ComputeSignatureRequest()
        if include_optional:
            return ComputeSignatureRequest(
                layers = [
                    'nix'
                    ],
                environment = ''
    ...
    def testComputeSignatureRequest(self):
        """Test ComputeSignatureRequest"""
