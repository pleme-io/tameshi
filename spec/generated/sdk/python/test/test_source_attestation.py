...
class TestSourceAttestation(unittest.TestCase):
    """SourceAttestation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SourceAttestation:
        """Test SourceAttestation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SourceAttestation`
        """
        model = SourceAttestation()
        if include_optional:
    ...
    def testSourceAttestation(self):
        """Test SourceAttestation"""
