...
class TestAdmissionDecisionCounts(unittest.TestCase):
    """AdmissionDecisionCounts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdmissionDecisionCounts:
        """Test AdmissionDecisionCounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdmissionDecisionCounts`
        """
        model = AdmissionDecisionCounts()
        if include_optional:
            return AdmissionDecisionCounts(
                allowed = 56,
                denied = 56
            )
        else:
    ...
    def testAdmissionDecisionCounts(self):
        """Test AdmissionDecisionCounts"""
