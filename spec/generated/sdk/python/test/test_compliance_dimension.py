...
class TestComplianceDimension(unittest.TestCase):
    """ComplianceDimension unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComplianceDimension:
        """Test ComplianceDimension
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComplianceDimension`
        """
        model = ComplianceDimension()
        if include_optional:
    ...
    def testComplianceDimension(self):
        """Test ComplianceDimension"""
