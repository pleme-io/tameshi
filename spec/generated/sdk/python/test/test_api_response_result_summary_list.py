...
class TestApiResponseResultSummaryList(unittest.TestCase):
    """ApiResponseResultSummaryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseResultSummaryList:
        """Test ApiResponseResultSummaryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseResultSummaryList`
        """
        model = ApiResponseResultSummaryList()
        if include_optional:
            return ApiResponseResultSummaryList(
                data = [
                    tameshi_client.models.result_summary.ResultSummary(
                        id = '', 
                        environment = '', 
                        baseline = 'low', 
                        compliance_hash = '', 
    ...
    def testApiResponseResultSummaryList(self):
        """Test ApiResponseResultSummaryList"""
