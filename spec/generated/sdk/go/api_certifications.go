...
func (r ApiGetCertificationRequest) Execute() (*Certification, *http.Response, error) {
	return r.ApiService.GetCertificationExecute(r)
}

/*
GetCertification Get certification by name

Returns the full Certification resource including spec and status.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param name Name of the Certification resource
 @return ApiGetCertificationRequest
*/
func (a *CertificationsAPIService) GetCertification(ctx context.Context, name string) ApiGetCertificationRequest {
	return ApiGetCertificationRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
func (a *CertificationsAPIService) GetCertificationExecute(r ApiGetCertificationRequest) (*Certification, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CertificationsAPIService.GetCertification")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/certifications/{name}"
...
func (r ApiListCertificationsRequest) Execute() ([]CertificationSummary, *http.Response, error) {
...
func (a *CertificationsAPIService) ListCertificationsExecute(r ApiListCertificationsRequest) ([]CertificationSummary, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []CertificationSummary
	)
	...
	localVarPath := localBasePath + "/api/v1/certifications"
