...
func (r ApiGetComplianceReportRequest) Format(format string) ApiGetComplianceReportRequest {
	r.format = &format
	return r
}

func (r ApiGetComplianceReportRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
*/
func (a *ReportsAPIService) GetComplianceReport(ctx context.Context) ApiGetComplianceReportRequest {
	return ApiGetComplianceReportRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ReportsAPIService) GetComplianceReportExecute(r ApiGetComplianceReportRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReportsAPIService.GetComplianceReport")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/compliance/report"
